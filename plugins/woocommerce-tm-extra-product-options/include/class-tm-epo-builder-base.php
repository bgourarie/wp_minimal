	...
	private function init_elements(){
		...
		$this->elements_array=array(
			...
			"textfield"=>$this->add_element(
				"textfield",
				array("required","price","text_before_price","text_after_price","price_type2","hide_amount","quantity","placeholder","min_chars","max_chars","default_value","min","max","validation1")
				),
