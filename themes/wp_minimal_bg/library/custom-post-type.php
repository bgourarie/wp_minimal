...
function project_euler_solutions() { 
	// creating (registering) the custom type 
	register_post_type( 'project_euler', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Euler Solutions', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Euler Solution', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Euler Solutions', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Euler Solution', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Euler Solution', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Euler Solution', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Euler Solution', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Euler Solution', 'bonestheme' ), /* Search Custom Type Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'These explain how to solve various Project Euler problems', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
	...
	register_taxonomy_for_object_type( 'category', 'project_euler' );
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type( 'post_tag', 'projet_euler' );
	
}

	// adding the function to the Wordpress init
	add_action( 'init', 'project_euler_solutions');
